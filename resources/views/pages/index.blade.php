...
.cardone.cardverse {
  --color1: #ffdf35;
  --color2: #65f0ff;
  background-image: url("kryptodog.png");
}
.cardone.mew {
  --color1: #eb8bff;
  --color2: #7eeefa;
...
.cardone.cardverse:after {
  opacity: 1;
  background-image: url("https://media.giphy.com/media/Ogak8XuKHLs6PYcqlp/giphy.gif");
  background-position: center;
  background-size: 160%;
  z-index: 2;
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 offset-lg-4">
                    ...
                    <h3 style="color:white; text-align:center; font-weight:bold;">Krypto Inu</h3>
       ...
       <div class="basic-1 " style="background-color:black">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <h3 style="color: red;"> Krypto Inu Tokenomics </h3>
...
<table style="width:100%;border:white;">
  ...
  <tr>
    <td> <h5 style="color:white;">Token Name: Krypto Inu</h5>  </td>
  </tr>
  <tr>
  <td> <h5 style="color:white;">Token Symbol: Krpinu</h5> </td>
  </tr>

  <tr>
  <td> <h5 style="color:white;">Token Platform: BSC</h5> </td>
  </tr>

  <tr>
  <td> <h5 style="color:white;">Total Supply: 1 quadtrillion</h5>   </td>

  </tr>
  <tr>
  <td> <h5 style="color:white;">Buy Tax: 10% </h5> </td>

  </tr>

  <tr>
  <td> <h5 style="color:white;">Sell Tax: 15%</h5>  </td>

  </tr>

  <tr>
    <td> <h5 style="color:white;" >Launch Date: December 17th, 2021 9pm EST</h5> </td>
  </tr>
</table>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2 class="vouch-merchant-customerh2" style="text-align: center; padding-bottom:80px; font-size: 60px; color:white; ">RoadMap</h2>

                    <div class="question-title">
                        <h3 style="color:white;">December 2021 (The Beginning)</h3>
                        <div class="content-main">
                            <div class="content-inner">
                                <p style="color:black;">
                                Krypto Inu launch BSC Network <br>
                                Apply for CoinMarketCap and CoinGecko <br>
                                Apply For Top CEX Exchanges <br>
                                Exclusive Krypto Inu NFT <br>
                                Heavy Marketing with Top Influencers
                            </p>
                            </div>
                    ...
                    <div class="question-title">
                        <h3 style="color:white;"> January 2022 (Expansion)</h3>
                        <div class="content-main">
                            <div class="content-inner">
                                <p style="color:black;">
                                Billboards in Major Cities <br>
                                Apply for more Cex Exchanges <br>
                                Marketing: Advertising on Major Websites, Youtubers, Influencers
                            </p>    
                            </div>
                    ...
                    <div class="question-title">
                        <h3 style="color:white;"> Febuary 2022 (Utility)</h3>
                        <div class="content-main">
                            <div class="content-inner">
                                <p style="color:black;">
                                Building a MEME NFT Marketplace For BSC Projects
                            </p>    
                            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <h2 class="vouch-merchant-customerh2" style="text-align: center; padding-bottom:80px; font-size: 60px; color:white; ">FAQ</h2>
                    ...
                    <div class="question-title">
                        <h3 style="color:white;">  What is Kyrpto Inu?</h3>
                        <div class="content-main">
                            <div class="content-inner">
                                <p style="color:black;">
                                Meme coin Top Superhero Dog that 100x this holiday Season, come and be apart of the ride.
                            </p>
                            </div>
                    ...
                    <div class="question-title">
                        ...
                        <div class="content-main">
                            <div class="content-inner">
                                <p style="color:black;">Pancakeswap.</p>
                            </div>
